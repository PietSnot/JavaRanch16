 ...
 * @author Piet
 */
public class BlaineJackson {

}

class JVacationFrame extends JFrame implements ActionListener {
...
class JVacationFrameDemo {

    public static void main(String[] args) {
        // TODO code application logic here
        JVacationFrame v = new JVacationFrame();
        v.setVisible(true);
    }
}
